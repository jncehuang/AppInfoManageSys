        ...
        <form class="form-horizontal form-label-left" action="/appManager/flatform/dataDictionary/DatadictionAddSave" method="post" id="myform">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <input type="text" name="typeCode" id="typeCode" class="form-control"  required="required" placeholder="请输入类型编码"  readonly="readonly"/>
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              ...
              <label id="valueIdForCheck"></label>
            </div>
          </div>
          <div class="item form-group">
...
<script src="${pageContext.request.contextPath }/statics/localjs/DictionaryaddForValue.js"></script>